...
func TestReservedPackID(t *testing.T) {
	...
	if !ReservedPackID("ubuntu", off) || !ReservedPackID("ubuntu-2604", off) || !ReservedPackID("ubuntu-2604-gnome", off) || !ReservedPackID("ubuntu-2604-cinnamon", off) || !ReservedPackID("ubuntu-2604-budgie", off) || !ReservedPackID("ubuntu-2404-mate", off) || !ReservedPackID("ubuntu-2604-plasma", off) || !ReservedPackID("ubuntu-autoinstall", off) {
