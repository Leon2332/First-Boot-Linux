"""Linux Mint 22.3 Cinnamon — FBL-native unpack.

Catalog ``install``: ``mint-223-cinnamon``.
Do not reuse this file for Mint MATE, Xfce, or Ubuntu.
...
ID = "mint-223-cinnamon"
ALIASES: tuple[str, ...] = ()


class Mint223Cinnamon:
    id = ID
    aliases = ALIASES
    default_hostname = "mint"
    display_name = "Linux Mint 22.3 Cinnamon"
