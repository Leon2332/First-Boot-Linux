"""Debian 13 MATE — FBL-native unpack.

Catalog ``install``: ``debian-13-mate``.
Do not reuse this file for Debian GNOME, KDE, Cinnamon, Xfce, or later Debian
