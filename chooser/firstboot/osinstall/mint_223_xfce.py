"""Linux Mint 22.3 Xfce — FBL-native unpack.

Catalog ``install``: ``mint-223-xfce``.
Do not reuse this file for Mint Cinnamon, MATE, or Ubuntu.
...
class Mint223Xfce:
    ...
    display_name = "Linux Mint 22.3 Xfce"
