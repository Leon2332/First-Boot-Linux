"""Debian 13 Cinnamon — FBL-native unpack.

Catalog ``install``: ``debian-13-cinnamon``.
Do not reuse this file for Debian GNOME, KDE, MATE, Xfce, or later Debian
versions. Live identity is ``user``; the customer form is the installed user.
Copy Debian's shim, not Canonical GRUB. Display manager is LightDM.
"""
...
ID = "debian-13-cinnamon"
ALIASES: tuple[str, ...] = ()


class Debian13Cinnamon:
    id = ID
    aliases = ALIASES
    default_hostname = "debian"
    display_name = "Debian 13 Cinnamon"
