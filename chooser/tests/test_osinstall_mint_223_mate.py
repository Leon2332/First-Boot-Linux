#!/usr/bin/env python3
"""Linux Mint 22.3 MATE native installer."""
...
from firstboot.osinstall.mint_223_mate import DRIVER, ID  # noqa: E402
...
class Mint223MateTests(unittest.TestCase):
    def test_driver_contract(self) -> None:
        self.assertEqual(ID, "mint-223-mate")
