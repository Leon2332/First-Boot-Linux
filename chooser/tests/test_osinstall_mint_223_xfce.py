#!/usr/bin/env python3
"""Linux Mint 22.3 Xfce native installer."""
...
from firstboot.osinstall.mint_223_xfce import DRIVER, ID  # noqa: E402
...
class Mint223XfceTests(unittest.TestCase):
    def test_driver_contract(self) -> None:
        self.assertEqual(ID, "mint-223-xfce")
    ...
    def test_configure_writes_customer_not_live_user(self) -> None:
        ...
        try:
            ...
            self.assertIn("user-session=xfce", lightdm)
